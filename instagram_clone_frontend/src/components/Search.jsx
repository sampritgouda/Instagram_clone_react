...
const Search = ({ onclose }) => {
  ...
  return (
    <div className='flex-column border-end border-secondary position-fixed bg-black serach-container' style={{ width: "300px", height: "100vh", top: 0, left: 0, zIndex: 9999 }}>

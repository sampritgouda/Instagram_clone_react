          ...
          {savedAccounts && savedAccounts.length > 0 ? (
            savedAccounts.map((acc) => {
              ...
              return (
                <div
                  key={acc.id}
                  className={`d-flex align-items-center justify-content-between p-2 rounded-3 mb-2 transition-all ${isActive ? 'bg-secondary bg-opacity-25' : 'bg-transparent hover-bg-dark'
                    }`}

...
const Profile = ({ user }) => {
  ...
  return (
    <div className='container-fluid bg-black mt-4 d-flex gap-3' >
      ...
      <div className='d-flex flex-column gap-3 justify-content-center px-1 px-md-5 profile-right-container'>
        <div className='d-flex gap-3 align-items-center'>
          <p className='text-white m-0 username' style={{ fontSize: '23px' }}>{user.username}</p>
          {(user.own) ? (
            <>
